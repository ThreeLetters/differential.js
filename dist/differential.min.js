...
c):step(a,d,c)),b=!1;b&&(Stop=b)}}}window.D=function(a,d,b,c,h){b&&"object"!==typeof b&&("function"===typeof b?(b={done:b},c&&(b.duration=c),h&&(b.easing=h)):(b={duration:b},c&&(b.easing=c),h&&(b.done=h)));return animate(a,d,b||{})};D.addEase=function(a,d){Easings[a]="function"===typeof d?d:"object"===typeof d?4===d.length?generateBezier(d[0],d[1],d[2],d[3]):generateSpringRK4(d[0],d[1]):generateStep(d)};D.stop=function(){Stop=!0};
